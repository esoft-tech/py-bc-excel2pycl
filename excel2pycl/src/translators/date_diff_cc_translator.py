...
from excel2pycl.src.tokens import DateDiffControlConstructionToken
from excel2pycl.src.translators.abstract_translator import AbstractTranslator


class DateDiffControlConstructionTokenTranslator(AbstractTranslator):
    @classmethod
    def translate(cls, token: DateDiffControlConstructionToken, excel: Excel, context: Context) -> str:
