...
def create_test_table(file_name):
    ...
    data = [
        ...
        [10.24, '=TRUE()', '=FALSE()', 5, 44, 55, 34, 5.5, 1, 10, 2023, 10, 10, 5, 12, datetime(2022, 3, 31), datetime(2021, 11, 30)],
        [10.239584, '', 0, 1, 1, 1, 1, 1, 1, 1, datetime(2023, 10, 10), datetime(2023, 10, 10), datetime(
            2023, 10, 10), 12, 12, datetime(2022, 1, 1), datetime(2022, 1, 1)],
    ...
    ws.append(["ROUND", "OR", "AND", "VLOOKUP", "IF", "SUM", "SUMIF", "AVERAGE", "MIN",
               "MAX", "YEAR", "MONTH", "DAY", "IFERROR when_error", "IFERROR condition", "EOMONTH", "EOMONTH NEGATIVE"])
