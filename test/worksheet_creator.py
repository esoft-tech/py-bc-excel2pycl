...
def create_test_table(file_name):
    ...
    data = [
        ...
        ['=ROUND(A4, 2)', '=OR(B4, B5)', '=AND(C4, C5)', '=VLOOKUP(5, D4:D13, 1, FALSE())', '=IF(E6>E5, 44, 11)',
         ...
         '=EDATE(R4, 2)', '=EDATE(S4, -1)'],
        [10.24, '=TRUE()', '=FALSE()', 5, 44, 55, 34, 5.5, 1, 10, 2023, 10, 10, 5, 12, datetime(2022, 3, 31), datetime(2021, 11, 30), datetime(2011, 3, 15), datetime(2010, 12, 15)],
        [10.239584, '', 0, 1, 1, 1, 1, 1, 1, 1, datetime(2023, 10, 10), datetime(2023, 10, 10), datetime(
            2023, 10, 10), 12, 12, datetime(2022, 1, 1), datetime(2022, 1, 1), datetime(2011, 1, 15), datetime(2011, 1, 15)],
