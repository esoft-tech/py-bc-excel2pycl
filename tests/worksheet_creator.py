...
def create_test_table(file_name):
    ...
    data = [
        [
            "COUNT normal",
            "COUNT single cell",
            "COUNT num & string digits",
            "COUNT range & arg sequence",
    ...
    data = [
        [
            "COUNTIFS text condition",
            "COUNTIFS cell condition",
            "COUNTIFS lambda condition",
            "COUNTIFS expression condition",
            "COUNTIFS any text condition",
            "COUNTIF pattern text condition",
        ],
        [
            '=COUNTIFS(A4:A7;"яблоки";B4:B7;">55")',
            "=COUNTIFS(A4:A7;A5)",
            '=COUNTIFS(B4:B7;">55")',
            '=COUNTIFS(B4:B7;"<>"&B5)',
            '=COUNTIFS(A4:A7;"*")',
    ...
    data = [
        [
            "ADDRESS absolute",
            "ADDRESS absolute row, relative col",
            "ADDRESS absolute col, relative row",
            "ADDRESS relative",
            "ADDRESS absolute strict",
            "ADDRESS RC type col relative",
            "ADDRESS RC type col relative link sheet",
            "ADDRESS absolute link sheet & workbook",
            "ADDRESS HUGE",
        ],
        [
            "=ADDRESS(3;1)",
            ...
            "=ADDRESS(3;5;1)",
            "=ADDRESS(3;6;2;FALSE)",
            '=ADDRESS(3;7;2;FALSE;"mid")',
            '=ADDRESS(3;8;1;TRUE;"[WorkBook1]ASD")',
            "=ADDRESS(3;704)",
        ],
    ...
    data = [
        [
            "TODAY normal",
            "TODAY ADD DAY",
            "TODAY subtract today from date",
            "Get DAY from TODAY",
            "Get MONTH from TODAY",
            "Compare TODAY and TODAY",
        ],
        [
            "=TODAY()",
            "=TODAY() + 5",
            "=DATE(2024, 5, 24) - TODAY()",
            "=DAY(TODAY())",
            "=MONTH(TODAY())",
            "=TODAY() = TODAY()",
        ],
